     ...
     <div class="row col-4">
          <div class="col-10">
            <div class="card border-primary mb-3">
              <div class="card-header">En Caja</div>
              ...
              @else
               <div class="card-header" style="text-align: right;">Venta: {{$venta->venta}}</div>
               <div class="card-header"style="text-align: right;" >Gastos: {{$venta->gastos}}</div>
